...
router.post("/update", function(req, res){
	var city = req.body.city.charAt(0).toUpperCase()+req.body.city.substring(1);
		customer.updateOne({googleid: req.user.googleid},
			{$set: {houseNo: req.body.houseno,
              address: req.body.address,
							city: city,
							district: req.body.district,
							state: req.body.state,
							pincode: req.body.pincode,
							contact: req.body.contact}}, function(err, data){
				if(err){
					console.log(err);
				} else {
					console.log(data);
...
// router.get("/direction/maps", function(req, res){
// 		request("https://apis.mapmyindia.com/advancedmaps/v1/sz6ooxzlwaltji2z9dypw7j6ukhisbyk/route_adv/driving/77.131123,28.552413;77.113091,28.544649?", function(error, response, body){
